...
int digitPins[4] = {
    ...
    3,
    19
}; //pins for 7-segment multiplexing
...
ISR(TIMER1_COMPA_vect) {
    ...
    //if(a==true)
    {
        ...
        if ((ShReg_position == 0) && (digitalRead(TLAC) == LOW)) { // Serial.println(button);
            step1++;
        ...
        } else if ((ShReg_position == 1) && (digitalRead(TLAC) == LOW)) { //  Serial.println(button);
            step1++;
        ...
        } else if ((ShReg_position == 2) && (digitalRead(TLAC) == LOW)) { //  Serial.println(button);
            step1++;
            if (Err == true && step1 > 4 && (ShReg_position == 2) && (digitalRead(TLAC) == LOW)) {
                ...
                button = 8;
                //Serial.println(button);
            } else if (Err == false && step1 > 4 && (ShReg_position == 2) && (digitalRead(TLAC) == LOW)) { //Serial.println(button);
                lastDebounceTime = millis();
                step1 = 0;
                button = 3;
            }
